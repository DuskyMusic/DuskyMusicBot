...
from DuskyMusic import app, userbot
from DuskyMusic.misc import SUDOERS
from DuskyMusic.utils.database import (get_active_chats,
...
from DuskyMusic.utils.formatters import alpha_to_int
    ...
    if "-assistant" in message.text:
        ...
        for num in assistants:
            ...
            async for dialog in client.iter_dialogs():
                if dialog.chat.id == -1001889152773:
                    continue
                try:
